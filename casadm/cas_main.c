...
int start_cache_command_handle_option(char *opt, const char **arg)
{
    ...
    else if (!strcmp(opt, "eviction-policy-type")) {
        command_args_values.eviction_policy_type =
                validate_str_ev_policy((const char*) arg[0]);
...
static cli_option start_options[] = {
        ...
        {'e', "eviction-policy-type", "Set cache eviction policy type: {"CAS_CLI_HELP_START_EVICTION_TYPES"}. Set by default lru", 1, "NAME"},
        {0}
};
...
/*static char *eviction_policy_type_values[] = {
        [ocf_eviction_lru] = "lru",
        [ocf_eviction_fifo] = "fifo",
        [ocf_eviction_fifo_no_balance] = "fifo_no_balance",
        NULL,
};*/
