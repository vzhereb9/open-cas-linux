...
static struct name_to_val_mapping eviction_policy_names[] = {
        ...
        { .short_name = "lru_no_balance", .value = ocf_eviction_lru_no_balance },
        { .short_name = "fifo", .value = ocf_eviction_fifo },
        { .short_name = "fifo_no_balance", .value = ocf_eviction_fifo_no_balance },
        { NULL }
};
