...
#define EVICTION_POLICY_STR "cache_evp_policy"
...
{
    int result = 0;
    uint64_t cache_mode, cache_line_size, cache_evp_policy;
    ...
    result = cas_properties_get_uint(cache_props, EVICTION_POLICY_STR,
                                     &cache_evp_policy);
    if (result)
        goto error;
    ...
    cfg.eviction_policy = cache_evp_policy;
