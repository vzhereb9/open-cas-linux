...
typedef bool ( *_lru_no_balance_hash_locked_pfn)(struct ocf_request *req,
                                                 ocf_core_id_t core_id, uint64_t core_line);

/* Iterator state, visiting all eviction lists within a partition
   in round robin order */
struct ocf_lru_no_balance_iter
{
    /* per-partition cacheline iterator */
    ocf_cache_line_t curr_cline[OCF_NUM_EVICTION_LISTS];
    /* cache object */
    ...
    /* callback to determine whether given hash bucket is already
     * locked by the caller */
    _lru_no_balance_hash_locked_pfn hash_locked;
    /* optional caller request */
    struct ocf_request *req;
    /* 1 if iterating over clean lists, 0 if over dirty */
    bool clean : 1;
...
typedef bool ( *_fifo_hash_locked_pfn)(struct ocf_request *req,
                                       ocf_core_id_t core_id, uint64_t core_line);

/* Iterator state, visiting all eviction lists within a partition
   in round robin order */
struct ocf_fifo_iter
{
    /* per-partition cacheline iterator */
    ocf_cache_line_t curr_cline[OCF_NUM_EVICTION_LISTS];
    /* cache object */
    ...
    /* callback to determine whether given hash bucket is already
     * locked by the caller */
    _fifo_hash_locked_pfn hash_locked;
    /* optional caller request */
    struct ocf_request *req;
    /* 1 if iterating over clean lists, 0 if over dirty */
    bool clean : 1;
...
typedef bool ( *_fifo_no_balance_hash_locked_pfn)(struct ocf_request *req,
                                                  ocf_core_id_t core_id, uint64_t core_line);

/* Iterator state, visiting all eviction lists within a partition
   in round robin order */
struct ocf_fifo_no_balance_iter
{
    /* per-partition cacheline iterator */
    ocf_cache_line_t curr_cline[OCF_NUM_EVICTION_LISTS];
    /* cache object */
    ...
    /* callback to determine whether given hash bucket is already
     * locked by the caller */
    _fifo_no_balance_hash_locked_pfn hash_locked;
    /* optional caller request */
    struct ocf_request *req;
    /* 1 if iterating over clean lists, 0 if over dirty */
    bool clean : 1;
...
typedef bool ( *_lfu_hash_locked_pfn)(struct ocf_request *req,
                                       ocf_core_id_t core_id, uint64_t core_line);
...
struct ocf_lfu_iter
{
    ...
    /* callback to determine whether given hash bucket is already
     * locked by the caller */
    _lfu_hash_locked_pfn hash_locked;
    /* optional caller request */
    struct ocf_request *req;
    /* 1 if iterating over clean lists, 0 if over dirty */
    bool clean : 1;
...
typedef bool ( *_lfu_no_balance_hash_locked_pfn)(struct ocf_request *req,
                                                  ocf_core_id_t core_id, uint64_t core_line);

/* Iterator state, visiting all eviction lists within a partition
   in round robin order */
struct ocf_lfu_no_balance_iter
{
    /* per-partition cacheline iterator */
    ocf_cache_line_t curr_cline[OCF_NUM_EVICTION_LISTS];
    /* cache object */
    ...
    /* callback to determine whether given hash bucket is already
     * locked by the caller */
    _lfu_no_balance_hash_locked_pfn hash_locked;
    /* optional caller request */
    struct ocf_request *req;
    /* 1 if iterating over clean lists, 0 if over dirty */
    bool clean : 1;
